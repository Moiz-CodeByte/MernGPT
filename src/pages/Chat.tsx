...
const Chat = () => {
        ...
        <Box sx={{display: "flex", width: "100%",pb: "20px", bgcolor: "rgb(17,29,39)", borderRadius: 5, flexDirection: 'column', mx: 3}}>
           ...
           {auth?.user?.name[0]}{auth?.user?.name.split(" ")[1][0]}
                ...
                <Typography sx={{mx: "auto", fontFamily: "work sans"}}>
                   ...
                   You can ask some question related to knowledge, Business, Advices, Education, etc. But avoid sharing personal details.
                    </Typography>
                    <Button onClick={handleDeleteChats} sx={{width: "200px",  color:"white", fontWeight:700, borderRadius: 3, mx: "auto",my: "auto", bgcolor: red[300], ":hover": {bgcolor: red.A400}  }}>
                        Clear conservation
                        </Button>
        </Box>
    </Box>
    ...
    <Box sx={{display: "flex", flex:{md:0.8, xs: 1,sm: 1}, flexDirection: "column", px: 3}}>
        <Typography sx={{textAlign: "center",fontSize: "35px", color: "white", mb:2, mx: "auto", fontWeight: "500" }}>Model- GPT 3.5 Turbo</Typography>
